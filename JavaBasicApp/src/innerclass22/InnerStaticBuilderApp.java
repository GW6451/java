...
class Member{
	...
	public String toString() {
		return "회원 [ID=" + id + "  Name=" + name + "  Tel=" + tel + "  Address=" + addr + "]";
	}
	...
	static class Builder{
		...
		//5]멤버변수(선택항목)를 초기화 하는 세터(반환타입 Builder)
...
public class InnerStaticBuilderApp {
	...
	public static void main(String[] args) {
		//필수항목만  갖고 객체 생성
		Member member1 = new Member.Builder("KIM", "김길동").build();//build() 멤버 반환
