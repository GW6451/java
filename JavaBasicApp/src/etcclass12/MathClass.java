...
public class MathClass {
	...
	private static int pow(int num, int loop) {
		int gop = 1;
		for(int i=0; i<loop;i++) gop*=num;		
		return gop;
	}


	public static void main(String[] args) {
		//Math클래스는 인스턴스화(객체화/HEAP영역에 메모리생성) 불가]
		...
		System.out.println("[내가 만든 random() 메소드]");
