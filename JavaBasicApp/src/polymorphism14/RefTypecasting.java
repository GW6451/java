...
public class RefTypecasting {
	...
	public static void main(String[] args) {
		...
		System.out.println("base가 참조하는 클래스명:"+base.getClass().getName());//Base
