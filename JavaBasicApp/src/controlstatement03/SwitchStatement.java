...
public class SwitchStatement {
	...
	public static void main(String[] args) throws IOException {
		//switch문 : if 
		//형식:
			/*정수식(산술식): 연산의 결과값이 byte/short/int/char 타입으로  long형은 해당 안됨
		...
		//**switch문에는 정수식 즉 결과 값이  byte/short/int/char/String 타입이 와야함
		//switch(inputNumber % 3 == 0) {}//[x]
		//switch(inputNumber % 3 == 0 || inputNumber > 100) {}//[x]
		byte b = 5;
		switch(b) {//변수가 와도 됨(단, 타입은 byte/short/int/char/String만 가능)
			case 1:
			...
			case 2:
				System.out.println("b에 저장된 값 2");
				/*
				 break가 없는 경우 : 먼저 해당 case를 찾고 해당 case 아래 명령문들도 모두 차례로 실행됨
				 고로 반드시 break를 추가
				 */
			case 5:
		...
		//switch(ln % 3) {} //[x]l정수식이지만 연산결과가 long형이니까
		...
		/*
		  ...
		  case 값2:
		  case 값n: 실행문n; break;
		  값1인 경우, 값2인 경우, 값n인 경우에도 위의 실행문n이 실행됨.
		 */
		switch(inputNumber) {
			case 1:
			case 2:
			case 100:
			case 200:
				System.out.println("1이거나 2이거나 100이거나 200이거나");
				break;
			case 300:
