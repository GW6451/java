...
public class ArrayType02 {
	...
	public static void main(String[] args) {
		//2차원 배열 : 1차원 배열이 평면으로 쌓인것(평면)
		//1]배열선언
		//스택영역에 주소를 저장할 수 있는 arrNum이라는 이름의 메모리 생성
		...
		dynamic[0] = new int[3];//0의 열의 수를 3개로 할당 하겠다
								//그 주소를 dynamic[0]에 저장
		System.out.println("0행의 주소:"+dynamic+", 0행의 열의 수:"+dynamic[0].length);
		dynamic[1] = new int[1];
		System.out.println("1행의 주소:"+dynamic+", 1행의 열의 수:"+dynamic[1].length);
