...
<body>
	...
	<fieldset>
		...
		<form id="form1">
			이름 <input type="text" name="name" /> 나이 <input type="text"
				name="age" /> 주소 <input type="text" name="addr" /> <input
				type="button" value="확인" id="btn1" />
		</form>
	</fieldset>
	<fieldset>
	...
	<fieldset>
		...
		<form id="form3">
			​ 아이디 <input type="text" id="idput" value="kim" /> 이름 <input
				type="text" name="name" /> 나이 <input type="text" name="age" /> 주소
			<input type="text" name="addr" /> <input type="button" value="확인"
				id="btn3" />
		</form>
	</fieldset>
	<fieldset>
		<legend>DELETE메소드:아이디 받아서 삭제후 삭제된 데이타 보내기</legend>
		아이디 <input type="text" id="iddelete" value="park" /> <input
			type="button" value="확인" id="btn4" />
	</fieldset>
	<fieldset>
		...
		<form method="POST" action="<c:url value='/users/upload'/>"
			...
			이름 <input type="text" name="name" /> 나이 <input type="text"
				name="age" /> 주소 <input type="text" name="addr" /> 파일 첨부<input
				type="file" name="upload" /> <input type="submit" value="확인" />
		</form>
	</fieldset>
</body>
</html>
