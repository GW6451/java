...
public class MajorMethodOfFile {
	...
	public static void main(String[] args) {
		...
		*/
		String wExistFile="D:\\CCH\\Workspace\\JavaBasicApp\\src\\HelloWorld.java";
		...
		System.out.println(fwExistFile.length()+"바이트");//265
		System.out.println(fwNoExistFile.length()+"바이트");//0
		System.out.println(fuRelativeDir.length()+"바이트");//?
		System.out.println(fuAbsoluteDir.length()+"바이트");//0
		...
		File fexist = new File("D:/CCH/A.txt");
		...
		System.out.println(fcan.canRead() ?"읽기가능" :"읽가 불가");
		System.out.println(fcan.canWrite() ?"쓰기가능" :"쓰기 불가");
		System.out.println(fcan.canExecute() ?"실행가능" :"실행 불가");
		...
		*/
		...
		System.out.println("[파일 객체 반환:File[]]");
