...
public class Stream01 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("원본 배열의 0번방:"+mountains[0]);//한라산
		...
		System.out.println("[정렬:Stream의 sorted()사용-원본 컬렉션이 유지됨]");
		stream2 = list.stream();//다시 스트림 얻는다		
		//stream2.sorted().forEach(a->System.out.println(a));//오름 차순
		stream2.sorted((s1,s2)->s2.compareTo(s1)).forEach(a->System.out.println(a));//내림차순
		System.out.println("컬렉션의 0번방:"+list.get(0));
