...
public class InstanceOfOP {
	...
	public static void main(String[] args) {
		...
		//string =buffer;//[x]
		//buffer =string;//[x]
		System.out.println(string instanceof String? "string은 String타입니다" :"string은 String타입이 아니다");
		System.out.println(string instanceof Object? "string은 Object타입니다" :"string은 Object타입이 아니다");
		System.out.println(buffer instanceof StringBuffer? "buffer은 StringBuffer타입니다" :"buffer은 StringBuffer타입이 아니다");
		System.out.println(buffer instanceof Object? "buffer은 Object타입니다" :"buffer은 Object타입이 아니다");
