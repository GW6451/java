...
public class SilsuType {
	...
	public static void main(String[] args) {
		...
		float f2= ln+f1;//[o]
		System.out.println("f2="+f2);//300.0
		...
		iarea = (int)(radius*radius*pi);//314
		...
		System.out.println(d1*d2);//얘상:0.02,실제:0.020000000000000004 
