...
public class StringBasic {
	...
	public static void main(String[] args) {
		...
		*/
		...
		String str5="Hello";
		String str6="HELLO";
		System.out.println("==로 주소 비교 : "+(str5 == str6));//false
		//[대소문자 구분해서 비교-equals()메소드]
		System.out.println("equals()로 문자열 비교 : "+(str5.equals(str6)));//false
		//[대소문자 구분하지 않고 비교-equalsIgnoreCase()메소드]
		System.out.println("equals()로 문자열 비교 : "+(str5.equalsIgnoreCase(str6)));//true
		/*
