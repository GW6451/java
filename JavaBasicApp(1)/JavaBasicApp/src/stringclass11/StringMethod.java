...
public class StringMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println("park".equalsIgnoreCase(nick.trim())?"회원":"비회원 혹은 아이디오류");
		//2]toLowerCase()나 toUpperCase()사용
		System.out.println("PARK".equals(nick.toUpperCase().trim())?"회원":"비회원 혹은 아이디오류");
		System.out.println("park".equals(nick.toLowerCase().trim())?"회원":"비회원 혹은 아이디오류");
