...
public class ArrayListApp {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(list.remove("MASAN으로 바꾸기")?"삭제 성공":"삭제 실패");
		System.out.println(list.remove("MASAN 추가하기")?"삭제 성공":"삭제 실패");
		...
		list.remove("가산");
		System.out.println("[중복 저장된 가산 삭제후-인덱스가 빠른거]");
		for(Object obj:list) System.out.println(obj);
		//1-8]전체 삭제:
