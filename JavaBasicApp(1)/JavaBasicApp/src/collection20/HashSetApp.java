...
public class HashSetApp {
	...
	public static void main(String[] args) {
		...
		System.out.println(set.contains(100)?"100 있다":"100 없다");
		...
		System.out.println("삭제후 저당된 객체수:"+set.size());
		//1-9]전체 삭제 :boolean removeAll(Collection c)
		//void clear()		
		//set.removeAll(set);
		set.clear();
		System.out.println("전체 삭제후 저당된 객체수:"+set.size());
		//전체 삭제후 저장한 객체는 그대로 있다(set(컬렉션)에서만 제거됨)
		...
		System.out.println(set2.contains(new Student("가길동", 20, "2020학번")));
		//2-5]삭제
		//set2.remove(stu1);
		//set2.clear();
