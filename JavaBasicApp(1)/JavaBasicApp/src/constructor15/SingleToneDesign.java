...
public class SingleToneDesign {
	...
	public static void main(String[] args) {
		...
		no2.print();
		System.out.println(
				String.format("no1:%s,no2:%s,no1의 noShareVar:%s,no2의 noShareVar:%s",no1,no2,no1.noShareVar,no2.noShareVar));
		...
		System.out.println(
				String.format("st1:%s,st2:%s,st1의 shareVar:%s,st2의 shareVar:%s",st1,st2,st1.shareVar,st2.shareVar));
